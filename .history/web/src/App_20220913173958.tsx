...
function App() {
  return (
    <div className="max-w-[1344px] mx-auto flex items-center flex-col my-16">
      ...
      <div className='pt-1 bg-nlw-gradient self-stretch mt-8'>
        <div className='flex justify-between items-center py-6 px-8 bg-[#2A2634] rounded-l before:w-full before:h-2 before:bg-red'>
            {/* <div>
